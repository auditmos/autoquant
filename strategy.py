...
def strategy(df: pd.DataFrame) -> pd.Series:
    ...
    # Secondary: strong ADX with moderate DI + ATR filter
    atr_normal = atr14 < atr14.rolling(50).mean() * 1.5
    signals[trend_up & very_strong_trend & di_moderate_bullish & atr_normal] = 1
